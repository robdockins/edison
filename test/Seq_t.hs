...
prop_equals :: SeqTest Int seq => seq Int 
   -> seq Int -> seq Int -> Bool

prop_equals seq xs ys =
    (xs == ys) == (toList xs == toList ys)

prop_fromList :: SeqTest Int seq => seq Int
    -> [Int] -> Bool
...
prop_toList :: SeqTest Int seq => seq Int
    -> seq Int -> Bool
...
prop_single :: SeqTest Int seq => seq Int
    -> Int -> Bool
...
prop_lcons_rcons :: SeqTest Int seq => seq Int
    -> Int -> seq Int -> Bool
...
prop_lview_rview :: SeqTest Int seq => seq Int
    -> seq Int -> Bool
...
prop_lhead_rhead :: SeqTest Int seq => seq Int
   -> seq Int -> Property
...
prop_ltail_rtail :: SeqTest Int seq => seq Int
   -> seq Int -> Property
...
prop_append :: SeqTest Int seq => seq Int
   -> seq Int -> seq Int -> Bool

prop_append seq xs ys = 
    toList (append xs ys) == toList xs ++ toList ys

prop_null_size :: SeqTest Int seq => seq Int
   -> seq Int -> Bool
...
prop_reverse :: SeqTest Int seq => seq Int
   -> seq Int -> Bool

prop_reverse seq xs = 
    toList (reverse xs) == Prelude.reverse (toList xs)

prop_reverseOnto :: SeqTest Int seq => seq Int
   -> seq Int -> seq Int -> Bool
...
prop_map :: SeqTest Int seq => seq Int
   -> seq Int -> Bool

prop_map seq xs = 
    toList (map (+1) xs) == Prelude.map (+1) (toList xs)

prop_fold :: SeqTest Int seq => seq Int
   -> seq Int -> Bool
...
prop_fold1 :: SeqTest Int seq => seq Int
   -> seq Int -> Property
...
prop_reduce :: SeqTest Int seq => seq Int
   -> seq Int -> Bool
...
prop_reduce1 :: SeqTest Int seq => seq Int
   -> seq Int -> Property
...
prop_inBounds_lookup :: SeqTest Int seq => seq Int
   -> Int -> seq Int -> Bool
...
prop_update_adjust :: SeqTest Int seq => seq Int
   -> Int -> seq Int -> Bool
...
prop_withIndex :: SeqTest Int seq => seq Int
   -> seq Int -> Bool
...
prop_take_drop_splitAt :: SeqTest Int seq => seq Int
   -> Int -> seq Int -> Bool
...
prop_subseq :: SeqTest Int seq => seq Int
   -> Int -> Int -> seq Int -> Bool

prop_subseq seq i len xs =
    subseq i len xs == take len (drop i xs)

prop_filter_takeWhile_dropWhile :: SeqTest Int seq => seq Int
   -> Int -> seq Int -> Bool
...
prop_partition_splitWhile :: SeqTest Int seq => seq Int
   -> Int -> seq Int -> Bool
...
prop_zip_zipWith :: SeqTest Int seq => seq Int
  -> seq Int -> seq Int -> Bool
...
prop_zip3_zipWith3 :: SeqTest Int seq => seq Int
   -> seq Int -> seq Int -> seq Int -> Bool
...
prop_unzip_unzipWith :: (SeqTest Int seq,SeqTest (Int,Int) seq) => seq Int
   -> seq (Int,Int) -> Bool
...
prop_unzip3_unzipWith3 :: (SeqTest Int seq,SeqTest (Int,Int,Int) seq) => seq Int
   -> seq (Int,Int,Int) -> Bool
...
prop_concat seq = forAll (genss seq) $ \xss -> concat xss == foldr append empty xss

genss :: (SeqTest (seq Int) seq,SeqTest Int seq) => seq Int -> Gen (seq (seq Int))
genss seq = sized (\n -> resize (min 20 n) arbitrary)

prop_concatMap :: (SeqTest (seq Int) seq, SeqTest Int seq) => seq Int
   -> seq Int -> Property
